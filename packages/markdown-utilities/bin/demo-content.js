...
const { mkfileuuid, markdownPath, articleDir } = require('../lib/demo-content/_lib/files')
const bodycontent = require('../lib/demo-content/_lib/body-content')
const markdown = require('../lib/demo-content/_lib')
const frontmatter = require('../lib/demo-content/_lib/front-matter')
const images = require('../lib/demo-content/_lib/images')
const { urlpath } = require('../lib/demo-content/_lib/path')
